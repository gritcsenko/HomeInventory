...
public sealed class CuidIdentifierObjectBuilder<TObject>() : IdentifierObjectBuilder<CuidIdentifierObjectBuilder<TObject>, TObject, Cuid>
    where TObject : class, IIdBuildable<TObject, Cuid, CuidIdentifierObjectBuilder<TObject>>, IBuildableIdentifierObject<TObject, Cuid, CuidIdentifierObjectBuilder<TObject>>
{
