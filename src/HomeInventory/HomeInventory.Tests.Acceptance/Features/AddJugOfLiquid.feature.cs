...
namespace HomeInventory.Tests.Acceptance.Features
{
    ...
    public partial class AddAJugOfLiquidFeature : object, Xunit.IClassFixture<AddAJugOfLiquidFeature.FixtureData>, System.IDisposable
    {
...
#line hidden
        ...
        public AddAJugOfLiquidFeature(AddAJugOfLiquidFeature.FixtureData fixtureData, HomeInventory_Tests_Acceptance_XUnitAssemblyFixture assemblyFixture, Xunit.Abstractions.ITestOutputHelper testOutputHelper)
        {
        ...
        public static void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "Features", "Add a Jug of Liquid", @"    As a registered user
...
#line hidden
        ...
        [Xunit.TraitAttribute("FeatureTitle", "Add a Jug of Liquid")]
...
#line hidden
        ...
        [Xunit.SkippableFactAttribute(DisplayName="User bought a gallon jug of water from store")]
        [Xunit.TraitAttribute("FeatureTitle", "Add a Jug of Liquid")]
        [Xunit.TraitAttribute("Description", "User bought a gallon jug of water from store")]
        [Xunit.TraitAttribute("Category", "WI21")]
        public void UserBoughtAGallonJugOfWaterFromStore()
        {
            string[] tagsOfScenario = new string[] {
                    "WI21"};
            System.Collections.Specialized.OrderedDictionary argumentsOfScenario = new System.Collections.Specialized.OrderedDictionary();
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("User bought a gallon jug of water from store", null, tagsOfScenario, argumentsOfScenario, featureTags);
#line 30
this.ScenarioInitialize(scenarioInfo);
#line hidden
            if ((TagHelper.ContainsIgnoreTag(tagsOfScenario) || TagHelper.ContainsIgnoreTag(featureTags)))
...
#line hidden
#line 31
    testRunner.Given("User \"Causal.User@someorg.email\" bought a 1 gallon jug of \"Water\" at 12/02/2022 i" +
                        "n \"Lidl\"", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Given ");
#line hidden
#line 32
    testRunner.When("User stores jug in to the \"Pantry\" storage area", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "When ");
#line hidden
#line 33
    testRunner.Then("The \"Pantry\" storage area should contain 1 gallon jug of \"Water\" that will expire" +
                        " at 12/12/2032", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
#line hidden
#line 34
    testRunner.And("A transaction was registered: User bought 1 gallon jug of \"Water\" at 12/02/2022 i" +
                        "n \"Lidl\" and payed $0.99", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line hidden
            }
            this.ScenarioCleanup();
        }
        ...
        public class FixtureData : System.IDisposable
        {
            ...
            public FixtureData()
            {
                AddAJugOfLiquidFeature.FeatureSetup();
            }
            
            void System.IDisposable.Dispose()
            {
                AddAJugOfLiquidFeature.FeatureTearDown();
            }
        }
    }
}
